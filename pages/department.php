...
$('#previewing').attr('height' , '120px');
        ...
        <div class="progress progress-striped active">
         ...
         style="width: 85%;">85% Complete
         </div>
        </div>
		<h2>Provide your department clearance slip</h2><hr>
...
<hr id ="line">
    ...
    <div class="form-group">
        <label for="dog" >Upload Department Clip</label>
        <input type="file" name="file5" id="file" class="form-control" accept="image/*">
    </div>
    </div>
    </div>
