...
$('#previewing').attr('height' , '120px');
        ...
        <div class="progress progress-striped active">
         ...
         style="width: 70%;">70% Complete
         </div>
        </div>
		<h2>Provide your VSESC Slip</h2><hr>
...
<hr id ="line">
    ...
    <div class="form-group">
        <label for="dog" >Upload VSESC Slip</label>
        <input type="file" name="file4" id="file" class="form-control" accept="image/*">
    </div>
    </div>
    </div>
